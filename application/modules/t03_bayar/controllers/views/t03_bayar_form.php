    ...
    <body>
        ...
        <form action="<?php echo $action; ?>" method="post">
			<div class="form-group">
            	<label for="TripNo">TripNo <?php echo form_error('TripNo') ?></label>
            	<textarea class="form-control" rows="3" name="TripNo" id="TripNo" placeholder="TripNo"><?php echo $TripNo; ?></textarea>
        	</div>
			<div class="form-group">
