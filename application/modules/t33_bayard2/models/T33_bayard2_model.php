...
class T33_bayard2_model extends CI_Model
{

    public $table = 't33_bayard2';
    public $id = 'idbayard2';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        $this->db->like('idbayard2', $q);
		$this->db->or_like('idbayard', $q);
...
/* Location: ./application/models/T33_bayard2_model.php */
